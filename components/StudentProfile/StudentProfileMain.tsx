                                                                ...
                                                                <div className="row">
                                                                    <div className="col-md-6">
                                                                        <div className="contact-from-input mb-20">
                                                                            ...
                                                                            <input id='FirstName' type="text" placeholder="Tên" />
                                                                        </div>
                                                                    </div>
                                                                    <div className="col-md-6">
                                                                        <div className="contact-from-input mb-20">
                                                                    ...
                                                                    <div className="col-md-6">
                                                                        <div className="contact-from-input mb-20">
                                                                            <label htmlFor="Occupation">Vị trí</label>
                                                                            <input id='Occupation' type="text" placeholder="Vị trí" />
                                                                        </div>
                                                                    </div>
                                                                    <div className="col-md-12">
                                                                        <div className="contact-from-input mb-20">
                                                                            <label htmlFor="Bio">Tiểu sử</label>
                                                                            <textarea id='Bio' placeholder="Tiểu sử"></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div className="col-sm-12">
                                                                        <div className="cont-btn mb-20 mt-10">
                                                                            <button type='button' className="cont-btn">Cập nhật hồ sơ</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                            ...
                                                            <div className="row">
                                                                <div className="col-md-6">
                                                                    <div className="contact-from-input mb-20">
                                                                        ...
                                                                        <input id='Current' type="password" placeholder="Nhập mật khẩu" />
                                                                    </div>
                                                                </div>
                                                                <div className="col-md-6">
                                                                    <div className="contact-from-input mb-20">
                                                                        <label htmlFor="New">Mật khẩu mới</label>
                                                                        <input id='New' type="password" placeholder="Nhập mật khẩu" />
                                                                    </div>
                                                                </div>
                                                                <div className="col-md-6">
                                                                    <div className="contact-from-input mb-20">
                                                                        <label htmlFor="Retype">Nhập lại mật khẩu mới</label>
                                                                        <input id='Retype' type="password" placeholder="Nhập mật khẩu" />
                                                                    </div>
                                                                </div>
                                                                <div className="col-sm-12">
                                                                    <div className="cont-btn mb-20 mt-10">
